...
jQuery(window).load(function(){"use strict";jQuery("#loader").delay(100).fadeOut(),jQuery("#loader-wrapper").delay(100).fadeOut("fast"),jQuery(window).ready(function(){jQuery('.checkAutorizo input[type="radio"]').click(function(){jQuery(this).is(":checked")&&(Swal.fire({title:!1,html:'<div class="images-tratamiento"><img src="./assets/images/logo.svg" class="image-modal-tratamiento-datos" /><div class="modal-tratamiento-datos"><h4>Te informamos tus derechos como Titular de Datos Personales y los deberes del Responsable del Tratamiento de tus Datos</h4><p><b>a)</b> Tienes derecho a conocer, actualizar y rectificar tus datos personales, as\xed como a solicitar prueba de la autorizaci\xf3n otorgada al responsable del Tratamiento.</p><p><b>b)</b> El Responsable del Tratamiento deber\xe1 informarte previa recolecci\xf3n de tus Datos el Tratamiento que se le dar\xe1 y la finalidad del mismo. Recuerda que las finalidades te las informamos en el escrito de autorizaci\xf3n que encuentras <span class="highLightText" id="aquiCall">Aqu\xed</span></p><p><b>c)</b> Tienes derecho a revocar la autorizaci\xf3n y a solicitar la supresi\xf3n de tus Datos. </p><p><b>d)</b> Ante la Superintendencia de Industria y Comercio podr\xe1s presentar quejas por infracciones a la Ley 1581 de 2012 en las que incurra el Responsable.</p><p>En caso de que desees revocar tu autorizaci\xf3n o tengas alguna consulta o reclamo en materia de datos personales cont\xe1ctanos al correo electr\xf3nico: <a href="mailto:didacol@didacol.com" target="_blank">didacol@didacol.com</a> y <a href="mailto:servicioalcliente@derco.com.co" target="_blank">servicioalcliente@derco.com.co</a></p><p>Puedes consultar nuestra pol\xedtica de tratamiento aqu\xed: <a href="https://pracodidacol.com/wp-content/themes/pracodidacol/assets/pdf/POLITICA_INSTITUCIONAL_DE_TRATAMIENTO_Y_USO_DE_DATOS_E_INFORMACION_PERSONAL_2022.pdf" target="_blank">www.pracodidacol.com</a></p></div>',confirmButtonText:"Entendido",showCloseButton:!0}),jQuery(".checkAutorizoInfo").slideDown(300),jQuery("body, html").animate({scrollTop:jQuery(jQuery(".checkAutorizoInfo")).offset().top-350},300))}),document.addEventListener("click",e=>{let a=e.target;"aquiCall"===a.id&&Swal.fire({customClass:{container:"modal_terms",htmlContainer:"container"},html:'<p class="textPolitics">Con la presente autorizaci\xf3n del tratamiento de mis datos personales se me podr\xe1 contactar dentro de una misma semana y en m\xe1s de una ocasi\xf3n durante el mismo d\xeda mediante: <strong><u>sms, whatsapp, correo electr\xf3nico, direcci\xf3n de residencia, llamada telef\xf3nica y/o cualquier otro medio de comunicaci\xf3n instant\xe1neo o formal</u></strong> por motivos de: env\xedo de informaci\xf3n relacionada con todo el concepto de experiencia de cualquiera de las marcas que hacen parte de “Las Compa\xf1\xedas”, ya sea para fines de actualizaci\xf3n de datos, invitaci\xf3n a eventos, env\xedo de publicidad, fines estad\xedsticos, env\xedo de informaci\xf3n de productos y servicios, ofertas, descuentos, informaci\xf3n corporativa, auditorias, seguimientos, promociones, encuestas, llamadas de seguimiento, env\xedo de productos a la direcci\xf3n de residencia, as\xed como env\xedo de informaci\xf3n de campa\xf1as t\xe9cnicas de servicio, seguridad o “recall”, de productos financieros y de seguros para la adquisici\xf3n de bienes y servicios  de cualquiera de las marcas que hacen parte de “Las Compa\xf1\xedas”; de igual forma, esta autorizaci\xf3n comprende el mandato expreso para que mi informaci\xf3n haga parte de la Base de Datos de cualquiera de “Las Compa\xf1\xedas”, as\xed como tambi\xe9n pueda ser transferida y/o transmitida a otras compa\xf1\xedas externas del Grupo Inchcape con residencia en Colombia o en otros pa\xedses, incluyendo mas no limit\xe1ndose a las marcas de los productos que importa, comercializa y distribuyen “Las Compa\xf1\xedas” en Colombia.</p>'})}),jQuery('.checkNoAutorizo input[type="radio"]').click(function(){jQuery(this).is(":checked")&&jQuery(".checkAutorizoInfo").slideUp(300)})}),jQuery(window).on("scroll",function(){var e=jQuery(window).scrollTop();e>72?jQuery(".navbar").addClass("scroll"):jQuery(".navbar").removeClass("scroll");var a=jQuery(window).height();e>a?jQuery(".bgForm").addClass("close"):jQuery(".bgForm").removeClass("close").removeClass("open"),e>a?jQuery(".openForm").addClass("open"):jQuery(".openForm").removeClass("open")})}),jQuery(document).ready(function(e){"use strict";e(".navbar-nav li.nav-item").on("click",function(){e("#navbarSupportedContent").css("height","1px").removeClass("in").addClass("collapse"),e("#navbarSupportedContent").removeClass("show")}),e(".openForm").on("click",function(){e(".bgForm").toggleClass("open")}),e(".slim-wrap ul.menu-items.collapsed li a").on("click",function(){e(".collapse-button").click()}),e('.header a[href^="#"], .page a.btn[href^="#"], .page a.internal-link[href^="#"]').on("click",function(a){a.preventDefault();var o=this.hash,i=jQuery(o);e("html, body").stop().animate({scrollTop:i.offset().top-60},"slow","easeInSine",function(){window.location.hash="1"+o})}),e.scrollUp=function(a){var o=e.extend({},{scrollName:"scrollUp",topDistance:600,topSpeed:800,animation:"fade",animationInSpeed:200,animationOutSpeed:200,scrollText:"",scrollImg:!1,activeOverlay:!1},a),i="#"+o.scrollName;e("<a/>",{id:o.scrollName,href:"#top",title:o.scrollText}).appendTo("body"),o.scrollImg||e(i).text(o.scrollText),e(i).css({display:"none",position:"fixed","z-index":"2147483647"}),o.activeOverlay&&(e("body").append("<div id='"+o.scrollName+"-active'></div>"),e(i+"-active").css({position:"absolute",top:o.topDistance+"px",width:"100%","border-top":"1px dotted "+o.activeOverlay,"z-index":"2147483647"})),e(window).on("scroll",function(){switch(o.animation){case"fade":e(e(window).scrollTop()>o.topDistance?e(i).fadeIn(o.animationInSpeed):e(i).fadeOut(o.animationOutSpeed));break;case"slide":e(e(window).scrollTop()>o.topDistance?e(i).slideDown(o.animationInSpeed):e(i).slideUp(o.animationOutSpeed));break;default:e(e(window).scrollTop()>o.topDistance?e(i).show(0):e(i).hide(0))}}),e(i).on("click",function(a){e("html, body").animate({scrollTop:0},o.topSpeed),a.preventDefault()})},e.scrollUp()});